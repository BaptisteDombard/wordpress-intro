...
//lancer la session php pour pouvoir essayer les variables de pages en pages
...
function dw_handle_submit_contact_form()
{
    ...
    if($errors = dw_validate_contact_form_data($data)) {
        ...
        //on redirige l'utilisateur vers le formulaire pour y afficher le feedback d'erreur.
        return wp_safe_redirect($_POST['_wp_http_referer'],302);
    }
